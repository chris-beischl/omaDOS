...
from omados.engine.cards import (
    Suit, Rank, DECK, CARD_TO_INDEX, CARD_POINTS, INDEX_TO_SUIT,
    Cards, OBER, UNTER, ASSE, EICHEL, HERZ, SUIT_LOOKUP
)
...
def test_suit_lookup_matrix():
    ...
    # Since Suit is a string Enum here, we check the SUIT_LOOKUP result matches the Enum index
